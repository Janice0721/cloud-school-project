...
public class ContentCodeGenerator {
	...
	//数据库密码
	private static final String DATA_SOURCE_PASSWORD  = "123123";
	//生成的表
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://127.0.0.1:3306/xc1010_content?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
